...
using WebAppTwoFactorGoogleAuth.Models;

namespace WebAppTwoFactorGoogleAuth.Controllers
{
    [Authorize]
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new WebAppTwoFactorGoogleAuth.Models.ApplicationUser { UserName = model.Email, Email = model.Email };
